...
func TestConfiguredTrackersListURLsEmptyUsesDefaults(t *testing.T) {
	...
	settings.StoreBTsets(&settings.BTSets{TrackersListURL: ""})
...
func TestConfiguredTrackersListURLsCustomPrepended(t *testing.T) {
	...
	settings.StoreBTsets(&settings.BTSets{TrackersListURL: " https://custom.example/list.txt "})
	got := configuredTrackersListURLs()
...
func TestConfiguredTrackersListURLsDedupe(t *testing.T) {
	...
	settings.StoreBTsets(&settings.BTSets{TrackersListURL: "https://a.example/list.txt"})
	got := configuredTrackersListURLs()
