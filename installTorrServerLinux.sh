...
getVersionTag() {
  # A full release tag (MatriX.142.LT-1.0.0, or legacy MatriX.142.LT-1.1.8) is used
...
checkGlibcCompatibility() {
  ...
  # marker (MatriX.142.LT-1.1.8 or MatriX.142.LT-1.0.0) qualifies regardless of the
