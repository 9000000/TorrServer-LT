...
[![GitHub License](https://img.shields.io/github/license/trinity-aml/TorrServer-LT)](https://github.com/trinity-aml/TorrServer-LT/blob/master/LICENSE)

Ported from upstream [YouROK/TorrServer](https://github.com/YouROK/TorrServer) (MatriX.144).
...
| `search_torrents` | RuTor, Torznab and/or JacRed, whichever are enabled in settings (`source`: `all`, `rutor`, `torznab`, `jacred`) |
