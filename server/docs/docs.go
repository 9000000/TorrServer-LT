    ...
    "paths": {
        ...
        "/jacred/search": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "JacRed torrent search result(s)",
                        "schema": {
                            "type": "array",
                            "items": {
        ...
        "/playlist": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Start the playlist at this file id (overrides fromlast)",
                        "name": "index",
                        "in": "query"
                    }
                ],
        ...
        "/torznab/caps": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Indexer index in the configured list",
                        "name": "index",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Indexer capabilities",
                        "schema": {
                            "$ref": "#/definitions/api.torznabCapsResponse"
                        }
                    }
                }
            }
        ...
        "/torznab/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Indexer index (-1 = all configured)",
                        "name": "index",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Torznab categories, comma-separated (default 5000,2000 = TV+Movies)",
                        "name": "cat",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Max results (default 100, capped at 250)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "api.torznabCapsCategory": {
            ...
            "properties": {
                ...
                "subcategories": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.torznabCapsCategory"
                    }
                }
            }
        },
        "api.torznabCapsResponse": {
            "type": "object",
            "properties": {
                "categories": {
                    "type": "array",
        ...
        "api.wafUpdateReq": {
            ...
            "properties": {
                ...
                "default_referers_enabled": {
                    "description": "Optional: omitted keeps the current state of the built-in denylist.",
                    "type": "boolean"
                },
                "referers": {
                    "type": "string"
        ...
        "settings.BTSets": {
            ...
            "properties": {
                ...
                "defaultTrackers": {
                    "description": "newline-separated announce URLs: the local list, merged after the remote one and used alone when it can't be fetched",
                    "type": "string"
                },
                "dhtconnectionsLimit": {
                    "description": "DHTConnectionsLimit caps DHT peer storage — libtorrent's dht_max_peers\n(max peers kept per torrent in the DHT), def 500. Keeps DHT from holding\nan unbounded number of peer endpoints.",
                    "type": "integer"
                },
                "disableDHT": {
                    "type": "boolean"
                ...
                "disableEndGame": {
                    "description": "turn off libtorrent strict_end_game_mode (def off = end-game on)",
                    "type": "boolean"
                },
                "disablePEX": {
                    "type": "boolean"
                ...
                "enableBonjour": {
                    "description": "Bonjour/mDNS LAN discovery (_torrserver, _http, _https); shares FriendlyName.",
                    "type": "boolean"
                },
                "enableDLNA": {
                    "description": "DLNA",
                ...
                "enableJacRedSearch": {
                    "description": "JacRed (single self-aggregating server: URL + optional API key)",
                    "type": "boolean"
                },
                "enableLPD": {
                    "description": "LPD",
                ...
                "trackersListURL": {
                    "description": "optional custom remote trackers list URL, tried before the built-in mirrors; empty = mirrors only",
                    "type": "string"
                },
                "trustedProxies": {
